...
# show_notebooks_table('localhost', 8888)
    ...
    parser.add_argument("--host", required=False, default="localhost", help="e.g. localhost")
    parser.add_argument("--port", required=True, help="Port number, e.g., 9999")
    ...
    port = int(args.port) 
    # main
    show_notebooks_table(host, port)