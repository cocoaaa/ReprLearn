"""Tune the hyperparams of the specified model on the specified dataset
by sampling a hyerparam config from the grid space and pass it to `train.py`'s
main training code.

Required CLI args of `train.py`
-----------------
