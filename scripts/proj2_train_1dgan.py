"""
cs669 proj2
train gan from 1d z to 2d x that lies on 1dim manifold (ie. curve)

-created: 2022-04-18

- todo: update below
Required args:
    --model_name: "beta-vae", "dfvae", "dcgan", 'pgan", "ebgan" "wgangp", "ncsn"
    --data_name: "celeba"
...
To run:
nohup python scripts/train_gms.py \
--model_name="vae" --data_name="celeba" \
--latent_dim=10 &
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_root", type=str, default='./lightning_logs_sgm', help='root directory to save lightning logs')
